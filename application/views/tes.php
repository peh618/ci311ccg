<?php /* ini sebenarnya helper pada codeigniter atau laravel yang saya gunakan */
if (! function_exists('mapTree')) { /** * Assign high numeric IDs to a config item to force appending. * * @param  array  $array * @return array */ 
function mapTree($dataset, $parent = 0) { $tree = array(); foreach ($dataset as $id => $node)
{
